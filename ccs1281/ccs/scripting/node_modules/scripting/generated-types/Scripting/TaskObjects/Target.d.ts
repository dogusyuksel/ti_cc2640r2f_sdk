...
export interface Target {
	...
	/**
	 * Steps the target, stepping into function calls. Returns once the step operation
	 * is completed and the target is once again halted.
	 *
	 * If symbol information is loaded for the location at which the target is currently halted,
	 * then a source step is performed. Otherwise, or if explicitly ordered to do so, an assembly
	 * step is performed.
	 *
	 * @remarks
	 * Will throw if the target is not halted.
	 ...
	 * ```
	 *
	 * @param explicitlyAsm - If true, an assembly step into operation will always be performed
	 * regardless of loaded symbols
	 */
	stepInto(explicitlyAsm?: boolean): void;

	/**
	 * Steps the target, stepping over function calls. Returns once the step operation is completed
	 * and the target is once again halted.
	 *
	 * If symbol information is loaded for the location at which the target is currently halted,
	 * then a source step is performed. Otherwise, or if explicitly ordered to do so, an assembly
	 * step is performed.
	 ...
	 * ```
	 *
	 * @param explicitlyAsm - If true, an assembly step over operation will always be performed
	 * regardless of loaded symbols
	 */
	stepOver(explicitlyAsm?: boolean): void;

	/**
	 * Steps the target, stepping out of the current function. Returns once the step operation is completed
	 * and the target is once again halted.
	 *
	 * @remarks
	 * Will throw if the target is not halted.
	 *
	 * This operation requires symbol imformation to be loaded for the location at which the target
	 * is currently halted.
	 *
	 * @example
	 * ```
