...
export { initScripting, ScriptingOptions, sleep } from "./scriptingWrapper";
export { ScriptingTimeoutError } from "./errors";
/**
...
export interface DebuggerScripting extends DebuggerRootObject {
     ...
     *
     * @returns the timeout duration in milliseconds, or 0 if the timeout is disabled
     *
     * @example
     * ```
    ...
    /**
     * @internal
     * Trace scripting module (internal for now)
     */
    trace: unknown;
}
/**
...
export { Simultaneous } from "./generated-types/Scripting/DebuggerObjects/Simultaneous";
...
export { GlobalBreakpoint } from "./generated-types/Scripting/TaskObjects/GlobalBreakpoint";
