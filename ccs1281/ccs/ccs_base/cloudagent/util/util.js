...
exports.encodeBase64 = exports.mkdirRecursive = exports.deleteFolderRecursive = exports.ctxPromisify = exports.allSettled = exports.osBitSize = exports.installerOS = exports.isOSX = exports.isLinux = exports.isWin = void 0;
const fs = require("fs");
...
function encodeBase64(chunk) {
    const buffer = chunk instanceof Buffer ? chunk : Buffer.from(chunk, "binary");
