OVERVIEW
--------
Spectrum Digital XDS560v2 STM USB/LAN update for Windows and linux.

WINDOWS INSTRUCTIONS 
******* ************
- The following files are provided as part of the XDS560V2 CCSv9 update.

  <ccsv9_install_dir>\ccs\ccs_base\common\uscif
  ...
  <ccsv9_install_dir>\ccs\common\uscif\sd560v2_updates
     sd_xds560v2_firmware_2.2.0.5 - Production HW XDS560v2 STM emulator application file system update file 
   
  <ccsv9_install_dir>\ccs\common\TargetDB\connections
     SD560V2LAN_Connection.xml      - LAN connection file
     SD560V2USB_Connection.xml      - USB connection file
     SD560V2TRAVELER_Connection.xml - Traveler (USB) connection file
...
- The following files are provided as part of the XDS560V2 CCSv9 update.
  ...
  <ccsv9_install_dir>/ccs/ccs_base/common/uscif/sd560v2_updates
     sd_xds560v2_firmware_2.2.0.5 - Production HW XDS560v2 STM emulator application file system update file 
   
  <ccsv9_install_dir>/ccs/ccs_base/common/targetdb/connections
     SD560V2LAN_Connection.xml      - LAN connection file
     SD560V2USB_Connection.xml      - USB connection file
     SD560V2TRAVELER_Connection.xml - Traveler (USB) connection file
...
dtc_conf update sd560v2e 10.0.3.49 sd560v2_updates\sd_xds560v2_firmware_2.2.0.5
dtc_conf update sd560v2u 0 sd560v2_updates\sd_xds560v2_firmware_2.2.0.5
...
From the command line,
	$ cd <ccsv9_install_dir>/ccs/ccs_base/common/uscif
