...
const TiWidgetButton = class {
    ...
    render() {
        // JSXON
        return this.base.render(h("ti-button", { appearance: this.appearance, disabled: this.disabled, onClick: () => !TiUtils.isInDesigner ? this.bindableTrigger++ : null }, h("div", { class: "content" }, this.icon ? h("ti-widget-icon", { appearance: "custom", size: "m", icon: this.icon }) : null, h("span", null, this.label))), { caption: this.caption, infoText: this.infoText });
        // JSXOFF
    } 
    componentDidRender() {
