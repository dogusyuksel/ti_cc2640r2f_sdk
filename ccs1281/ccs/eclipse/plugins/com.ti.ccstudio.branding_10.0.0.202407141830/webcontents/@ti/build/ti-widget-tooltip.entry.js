...
const TiWidgetTooltip = class {
    ...
    render() {
        // JSXON
        return (h("ti-tooltip-trigger", { class: "ti-tooltip-trigger" }, h("slot", null), h("ti-tooltip", { class: "ti-tooltip", position: this.positionSelected }, this.text)));
        // JSXOFF
    } 
    positionChanged() {
     ...
     */
    findAnchor() {
        const anchor = (this.anchorId && this.anchorId !== 'elementWrapper') 
            ? this.el.parentElement.querySelector(`#${this.anchorId}`) || document.querySelector(`#${this.anchorId}`) 
            : this.el.parentElement; 
        const bound = anchor.getBoundingClientRect(); 
        if (this.anchorId && this.anchorId !== 'help-icon' && this.anchorId !== 'elementWrapper') { 
            // set position for top-level widget anchoring
            this.el.style.top = `${bound.top}px`; 
            this.el.style.left = `${bound.left}px`; 
        } 
        // set size to match anchor div
        this.el.style.width = `${bound.width}px`; 
        this.el.style.height = `${bound.height}px`; 
    } 
    componentDidLoad() {
