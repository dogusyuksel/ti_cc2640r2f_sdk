...
import { AbstractDataCodec } from '../lib/AbstractCodec';
import { PrimitiveDataType } from '../lib/CodecDataTypes';
const numberDataType = new PrimitiveDataType('number');
;
class NullConnectionLogger {
...
;
class CodecStub extends AbstractDataCodec {
    constructor(params) {
...
describe('TargetConfiguration', () => {
    ...
    before(() => {
        ...
        CodecRegistry.clear(); // clear the registery to avoid other tests clashing with this one.
...
//# sourceMappingURL=TargetConfiguration.spec.js.map