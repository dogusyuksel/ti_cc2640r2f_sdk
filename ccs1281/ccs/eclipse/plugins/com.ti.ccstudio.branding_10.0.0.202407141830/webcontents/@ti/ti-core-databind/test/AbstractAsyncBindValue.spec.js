...
import { AbstractAsyncBindValue, valueChangedEventType, Status, ProgressCounter, QUALIFIER, RefreshIntervalBindValue } from '../lib/CoreDatabind';
describe('AbstractAsyncBindValue', () => {
    const model = new (class TestModel extends Events {
        constructor() {
            super(...arguments);
            this.id = 'dummy';
            this._ignoreWriteOperationsWhenDisconnected = false;
        }
        getBinding() {
    ...
    class AsyncBindValue extends AbstractAsyncBindValue {
        constructor() {
            ...
            this.changedListenerHandler = (details) => {
                this.counter++;
        ...
        ;
        addReadResult(expected) {
            this.readResults.push(expected);
        }
        ;
        addWriteResult(expected) {
            this.writeResults.push(expected);
        }
        ;
        verifyIdleState(value, notifyCount) {
...
//# sourceMappingURL=AbstractAsyncBindValue.spec.js.map