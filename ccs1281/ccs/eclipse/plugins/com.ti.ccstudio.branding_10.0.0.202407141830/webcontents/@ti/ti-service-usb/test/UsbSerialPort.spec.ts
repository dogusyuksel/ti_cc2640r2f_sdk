...
import { dsServiceType, IDSService, IDebugCore, debugCoreType } from '../../ti-service-ds/lib/DSService';
import { usbServiceType, IUsbService } from '../lib/UsbService';
import { usbSerialPortType, IUsbSerialPort, IOpenedEvent, IClosedEvent, IDataEvent, openedEventType, closedEventType, dataEventType} from '../lib/UsbSerialPort';
