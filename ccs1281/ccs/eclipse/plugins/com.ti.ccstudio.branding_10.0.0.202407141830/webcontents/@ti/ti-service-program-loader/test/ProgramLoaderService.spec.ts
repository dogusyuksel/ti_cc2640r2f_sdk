...
import { dsServiceType, IDebugCore, debugCoreType, statusMessageEventType, Location, IStatusMessageEvent } from '../../ti-service-ds/lib/DSService';
import { TiFiles } from '../../ti-core-assets/lib/TiFiles';

/** Enabled Logging *********************************************************************************************************** */
TiConsole.setLevel('programLoaderService', processArgs[ARG_ENABLE_LOG] as number);
/** *************************************************************************************************************************** */
