...
Polymer({
    ...
    getViewCallback: function (error, viewData, moduleName, viewName) {
        ...
        for (var i = 0; i < viewData.length; i++) {
            ...
            for (var j = 0; j < heap.elements.length; j++) {
                ...
                error = block.Address$status;       /* Address error msg */
            }

            /* report address error (if any) */
            if (error != null) {
                this.rovViewStatus(error, 'error');
            }
    ...
    */
    ...
    attached: function () {
        ...
        this.$.graph.style.width = this.graphWidth + 'px';
        this.$.graph.style.height = this.graphHeight + 'px';
