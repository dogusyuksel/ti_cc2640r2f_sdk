...
exports.getWindowsSystemProxy = void 0;
async function getWindowsSystemProxy() {
    var _a;
    if (process.platform !== 'win32') {
        throw new Error("Can't detect windows system proxy on non-Windows platform");
    }
    const registry = await Promise.resolve().then(() => require('registry-js'));
    const proxyValues = registry.enumerateValues(registry.HKEY.HKEY_CURRENT_USER, 'Software\\Microsoft\\Windows\\CurrentVersion\\Internet Settings');
    ...
    const proxyOverride = (_a = getValue(proxyValues, 'ProxyOverride')) === null || _a === void 0 ? void 0 : _a.data;
    ...
    const proxyConfigString = proxyServer.data;
...
exports.getWindowsSystemProxy = getWindowsSystemProxy;
const getValue = (values, name) => values.find((value) => (value === null || value === void 0 ? void 0 : value.name) === name);
