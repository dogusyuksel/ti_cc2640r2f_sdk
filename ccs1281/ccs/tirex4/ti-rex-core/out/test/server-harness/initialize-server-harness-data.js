...
})(ServerDataInput = exports.ServerDataInput || (exports.ServerDataInput = {}));
///////////////////////////////////////////////////////////////////////////////
/// Code
///////////////////////////////////////////////////////////////////////////////
/**
...
function generateNodeData(data) {
    ...
    const result = Object.keys(nodes)
        ...
        if (node.nodeType === response_data_1.Nodes.NodeType.FOLDER_NODE) {
            ...
            if (!icon) {
                nodeDataCommon.descriptor.icon = "File" /* FILE */;
            }
            result = {
                node: {
                    ...nodeDataCommon,
            ...
            if (!icon) {
                nodeDataCommon.descriptor.icon = "Package" /* PACKAGE */;
            }
            result = {
                node: {
                    ...nodeDataCommon,
...
function generateTableItemData(data) {
    ...
    const result = Object.keys(tableItems)
        ...
        variants.forEach(({ variant, nodeDbId }) => {
            resolvedVariants[util_2.getTableItemVariantAsString(variant)] = nodeDbId;
        });
        return {
            tableItemData: {
                tableItemDbId,
...
function sortPackages(packages) {
    return util_1.sortVersionedItems(packages, 'packagePublicId', 'packageVersion');
}
/**
...
function sortPackageGroups(groups) {
    return util_1.sortVersionedItems(groups, 'packageGroupPublicId', 'packageGroupVersion');
}
...
function generatePackageGroups(packages) {
    ...
    return Object.entries(groups).map(([packageGroupPublicUid, packagesPublicUids]) => {
        const mainPkg = packages.find(pkg => packagesPublicUids.includes(pkg.packagePublicUid) &&
            pkg.packageType === "MainPackage" /* MAIN_PACKAGE */);
        if (!mainPkg) {
