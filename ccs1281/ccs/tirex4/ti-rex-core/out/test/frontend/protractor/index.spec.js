...
describe('[frontend] Index', function () {
    ...
    it('Should be possible to go home by clicking on the nav title - REX-2712#1', async function () {
        ...
        await protractor_1.element(protractor_1.by.id(util_2.TEST_ID.navbarTitle)).click();
        ...
        expect_1.expect(url).to.deep.include(test_helpers_1.testingGlobals.remoteserverUrl);
    });
});
