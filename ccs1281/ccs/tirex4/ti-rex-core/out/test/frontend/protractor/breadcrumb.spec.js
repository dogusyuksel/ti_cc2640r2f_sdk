...
const data1 = {
    ...
    nodeData: util_3.objectFromKeyValuePairs([
        packageNode2,
        packageNode3,
        packageNode4,
        folderNode2,
...
describe('[frontend] Breadcrumb', function () {
    ...
    beforeEach(async function () {
        await util_1.lightSetupProtractorTest({ apis, node: initalItem, urlQuery: {} });
    });
    ...
    it('Should handle selecting a node which is not an ancestor', async function () {
        ...
        await util_2.updateBrowserUrl({ apis, node: nonAncestorItem, urlQuery: {} });
