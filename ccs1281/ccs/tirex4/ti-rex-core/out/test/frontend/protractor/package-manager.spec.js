...
const data1 = {
    ...
    nodeData: util_3.objectFromKeyValuePairs(packageNodes.map(node => ({ key: node.nodeDbId, value: node })))
};
///////////////////////////////////////////////////////////////////////////////
// Tests
///////////////////////////////////////////////////////////////////////////////
describe('[frontend] PackageManager', function () {
    ...
    async function setup(urlQuery) {
        // Setup page
        await util_1.lightSetupProtractorTest({ apis, urlQuery: urlQuery || {} });
        // Open package manager
        await navbar_1.Navbar.openMenu();
        await util_2.clickElement(protractor_1.element(protractor_1.by.id(util_4.TEST_ID.navbarMenuPackageManager)));
        await protractor_1.browser.wait(protractor_1.ExpectedConditions.visibilityOf(protractor_1.element(protractor_1.by.id(util_4.TEST_ID.packageManagerTable))), 500, 'Package manager did not open');
