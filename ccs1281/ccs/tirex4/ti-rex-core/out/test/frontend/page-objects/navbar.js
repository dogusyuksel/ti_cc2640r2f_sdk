...
(function (Navbar) {
    ...
    async function openMenu() {
        await open_close_helpers_1.openItem(util_1.TEST_ID.navbarMenuButton, util_1.TEST_ID.navbarMenu);
    }
    Navbar.openMenu = openMenu;
    async function closeMenu() {
        await open_close_helpers_1.closeItem(util_1.TEST_ID.navbarMenuButton, util_1.TEST_ID.navbarMenu);
    }
    Navbar.closeMenu = closeMenu;
})(Navbar = exports.Navbar || (exports.Navbar = {}));
