...
(function (NodeContextMenu) {
    ...
    async function openInstall(node, apis) {
        ...
        await util_1.goToNode(node, apis);
        await openContextMenu(node.nodeDbId);
        await util_1.clickElement(protractor_1.element(protractor_1.by.id(util_2.TEST_ID.nodeContextMenuInstall)));
    }
    ...
    async function openUninstall(node, apis) {
        ...
        await util_1.goToNode(node, apis);
        await openContextMenu(node.nodeDbId);
        await util_1.clickElement(protractor_1.element(protractor_1.by.id(util_2.TEST_ID.nodeContextMenuUninstall)));
    }
    ...
    async function openManageVersions(node, apis) {
        ...
        await util_1.goToNode(node, apis);
        await openContextMenu(node.nodeDbId);
        await util_1.clickElement(protractor_1.element(protractor_1.by.id(util_2.TEST_ID.nodeContextMenuManageVersions)));
    }
    ...
    async function openDownload(node, apis) {
        ...
        await util_1.goToNode(node, apis);
        await openContextMenu(node.nodeDbId);
        await util_1.clickElement(protractor_1.element(protractor_1.by.id(util_2.TEST_ID.nodeContextMenuDownloadVersion)));
    }
    ...
    async function openImport(node, apis) {
        ...
        await util_1.goToNode(node, apis);
        await openContextMenu(node.nodeDbId);
        await util_1.clickElement(protractor_1.element(protractor_1.by.id(util_2.TEST_ID.nodeContextMenuImport)));
    }
    ...
    async function openContextMenu(nodeDbId) {
        ...
        await open_close_helpers_1.waitUntilItemOpen(buttonId);
        await protractor_1.browser
            .actions()
            .mouseMove(protractor_1.element(protractor_1.by.id(buttonId)))
            .click()
            .perform();
        await open_close_helpers_1.waitUntilItemOpen(util_2.TEST_ID.nodePresentationContextMenu);
        /*
    ...
    async function verifyDialogOpen() {
        await open_close_helpers_1.waitUntilItemOpen(util_2.TEST_ID.nodeContentMenuDialog);
    }
    NodeContextMenu.verifyDialogOpen = verifyDialogOpen;
})(NodeContextMenu = exports.NodeContextMenu || (exports.NodeContextMenu = {}));
