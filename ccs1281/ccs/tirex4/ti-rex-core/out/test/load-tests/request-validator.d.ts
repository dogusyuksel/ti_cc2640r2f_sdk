...
declare type APIsResult<T extends keyof IAPIs> = PromiseType<ReturnType<IAPIs[T]>>[];
...
declare class RequestSaver extends APIsBase implements IAPIs {
    getNodes(ids: string[]): Promise<(Readonly<import("../../shared/routes/response-data").Nodes.LeafNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderWithResourceNode> | Readonly<import("../../shared/routes/response-data").Nodes.PackageFolderNode>)[]>;
    ...
    getFilteredChildrenNodes(parentIds: string[], urlQuery: BrowserUrlQuery.Params): Promise<(Readonly<import("../../shared/routes/response-data").Nodes.LeafNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderWithResourceNode> | Readonly<import("../../shared/routes/response-data").Nodes.PackageFolderNode>)[][]>;
    ...
    fetchNodesResult(): (Readonly<import("../../shared/routes/response-data").Nodes.LeafNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderWithResourceNode> | Readonly<import("../../shared/routes/response-data").Nodes.PackageFolderNode>)[][];
    ...
    fetchFilteredChildrenNodesResult(): (Readonly<import("../../shared/routes/response-data").Nodes.LeafNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderWithResourceNode> | Readonly<import("../../shared/routes/response-data").Nodes.PackageFolderNode>)[][][];
