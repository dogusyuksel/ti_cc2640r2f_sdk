...
class SimulatedUser {
    ...
    async go() {
        ...
        await delay_1.delay(this.rand.generate(settings_1.viewNodeDelay * 5));
        ...
        if (_.isEmpty(childrenNodes[0]) && this.continueTraversing(true)) {
            ...
            if (nodeData) {
                ...
                if (extendedData.nodeType === response_data_1.Nodes.NodeType.LEAF_NODE) {
                    ...
                    await util_1.randomDelay(settings_1.viewNodeDelay, this.rand);
                }
            }
            return false;
        }
            ...
            while (!visited[index] && this.continueTraversing()) {
                visited[index] = true;
                await util_1.randomDelay(settings_1.expandNodeDelay, this.rand);
...
SimulatedUser.apiFactory = new request_validator_1.APIsFactory();
SimulatedUser.exceptionsLogged = 0;
