...
function getPayload(res) {
    ...
    expect_1.expect(parseInt(sessionId)).to.be.greaterThan(lastUpdate.getTime());
...
async function getNodesData(query) {
    return makeRequest("api/nodesData" /* GET_NODES_DATA */, query);
}
exports.getNodesData = getNodesData;
async function getNodeExtendedData(query) {
    return makeRequest("api/nodeExtendedData" /* GET_NODE_EXTENDED_DATA */, query);
}
exports.getNodeExtendedData = getNodeExtendedData;
async function getFilteredChildrenNodeIds(query) {
    return makeRequest("api/filteredChildrenNodeIds" /* GET_FILTERED_CHILDREN_NODE_IDS */, query);
}
exports.getFilteredChildrenNodeIds = getFilteredChildrenNodeIds;
async function getExpandedFilteredDescendantNodesData(query) {
    return makeRequest("api/expandedFilteredDescendantNodesData" /* GET_EXPANDED_FILTERED_DESCENDANT_NODES_DATA */, query);
}
exports.getExpandedFilteredDescendantNodesData = getExpandedFilteredDescendantNodesData;
async function getFilterOptions() {
    return makeRequest("api/filterOptions" /* GET_FILTER_OPTIONS */);
}
exports.getFilterOptions = getFilterOptions;
async function getRootNode() {
    return makeRequest("api/rootNode" /* GET_ROOT_NODE */);
}
exports.getRootNode = getRootNode;
async function getSearchSuggestions(query) {
    return makeRequest("api/searchSuggestions" /* GET_SEARCH_SUGGESTIONS */, query);
}
exports.getSearchSuggestions = getSearchSuggestions;
async function getNodeDbId(query) {
    return makeRequest("api/nodePublicIdToDbId" /* GET_NODE_PUBLIC_ID_TO_DB_ID */, query);
}
exports.getNodeDbId = getNodeDbId;
async function getNodeDbIdRex3(query) {
    return makeRequest("api/rex3LinkToDbId" /* GET_REX3_LINK_TO_DB_ID */, query);
}
...
async function updateDBContent(contentPath, options = {}) {
    ...
    return contentImporter_1.contentImport(dinfra, contentPath, scriptsUtil.getMochaConfig().dbResourcePrefix, {
        ...options,
        quiet: true
    });
}
