...
function generateSimpleCategories(records, packageOverview, overviews) {
    ...
    overviews === null || overviews === void 0 ? void 0 : overviews.forEach(overview => {
...
async function writeMetadata(data) {
    ...
    const dbFolder = test_helpers_1.getUniqueFolderName();
...
async function updateDatabaseImpl(data) {
    ...
    await sqldbImporter_1.metadataImport(dinfra, sqldb, folder, null, {
...
(function (DatabaseUpdateEvent) {
    ...
    if (test_helpers_1.testingGlobals.testConfig === scriptsUtil.TestConfig.REMOTESERVER) {
        ...
        dbUpdateInfo_1.registerDatabaseUpdateHandler(require(test_helpers_1.testingGlobals.dinfraPath), () => {
...
function expectValidDbId(id) {
    expect_1.expect(parseInt(id)).to.be.greaterThan(0);
}
