...
export declare type MinimalContentDevice = Pick<Device, 'name' | 'id' | 'type' | 'description'> & Partial<Device>;
export declare type MinimalContentDevtool = Pick<Devtool, 'name' | 'id' | 'type' | 'description'> & Partial<Devtool>;
export declare type MinimalContentPackageOverview = Partial<Overview> & Pick<Overview, 'name' | 'version' | 'type' | 'id' | 'description' | 'devices' | 'devtools' | 'metadataVersion' | 'supplements' | 'link'>;
export declare type MinimalContentResource = Partial<Resource> & Pick<Resource, 'name' | 'resourceType' | 'fileType' | 'link' | 'categories' | 'description' | 'devices' | 'devtools'>;
export declare type MinimalContentOverview = MinimalContentPackageOverview & {
    resourceType: 'overview';
};
export declare type MinimalContentCategory = MinimalContentPackageOverview & {
