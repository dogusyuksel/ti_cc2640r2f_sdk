...
export declare type MinimalDevice = Pick<Device, 'name' | 'id' | '_id' | 'packageUId'> & Partial<Device>;
export declare type MinimalDevtool = Pick<Devtool, 'name' | 'id' | 'type' | '_id' | 'packageUId'> & Partial<Devtool>;
export declare type MinimalPackageOverview = Partial<Overview> & Pick<Overview, 'name' | 'version' | 'type' | '_id' | 'packagePath' | 'resourceType' | 'packageVersion' | 'packageUId' | 'fullPaths' | 'fullPathsPublicIds' | 'id' | 'packageId' | 'semver'> & {
    localPackagePath?: string;
};
export declare type MinimalResource = Partial<Resource> & Pick<Resource, 'name' | '_id' | 'categories' | 'fullPaths' | 'fullPathsPublicIds' | 'linkType' | 'package' | 'resourceType'>;
export declare type MinimalOverview = MinimalPackageOverview & {
    resourceType: 'overview';
};
export declare type MinimalCategory = MinimalPackageOverview & {
...
declare type FullPathAndName = Pick<MinimalResource, 'fullPaths' | 'name'>;
/**
