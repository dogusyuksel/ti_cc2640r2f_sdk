...
declare type DbObjWriteOptions = WriteOptions & {
...
export declare class DbConnection {
    ...
    writeObjsToDb<T>(qid: string, objs: Iterable<T>, tableName: string, columnNames: string[], mapToDbRows: (obj: T) => DbValue[][], options?: WriteOptions): Promise<void>;
