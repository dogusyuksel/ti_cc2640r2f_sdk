...
exports.internalIdToString = exports.publicVIdToString = exports.stringToInternalId = exports.stringToVPublicId = exports.kernelToDb = exports.dbToKernel = exports.compilerToDb = exports.dbToCompiler = exports.rowToDevice = exports.rowToDevtool = exports.rowToFilterChunk = exports.rowToFilter = exports.resourceSortToDb = exports.dbToResourceSort = exports.rowToResource = exports.decomposeStringArray = exports.recomposeStringArray = exports.mysqlWordsToPublicId = exports.nodeRowToPublicId = exports.nodePublicIdToDbWords = exports.rowToNode = exports.rowToPackageDepend = exports.decomposePlatformAttribute = exports.recomposePlatformAttributeObject = exports.rowToPackage = exports.rowToFilterDevSet = exports.rowToPackageGroup = exports.rowToContentSource = void 0;
    ...
    return {
        ...
        moduleGroup: row.module_grp_core_pkg_pid || row.module_grp_core_pkg_vrange || row.module_grp_packages
            ? {
                ...
                packages: ((_a = row === null || row === void 0 ? void 0 : row.module_grp_packages) === null || _a === void 0 ? void 0 : _a.split(',')) || []
            }
            : null,
...
function nodePublicIdToDbWords(publicId) {
    const publicIdHex = dbBuilderUtils_1.base64UrlSafeToHex(publicId);
...
function mysqlWordsToPublicId(publicIdWord0, publicIdWord1) {
    ...
    return dbBuilderUtils_1.hexToBase64UrlSafe(hex);
}
...
function rowToResource(row) {
    if (!dbTypes_1.isResourceType(row.type)) {
