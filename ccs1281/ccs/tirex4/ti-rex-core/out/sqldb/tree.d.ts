...
export declare type Resource = DbResource;
...
export declare type PackageTreeNode = PresentationNode & {
...
declare type PresentationNodeRow = Pick<NodeRow, 'id' | 'public_id_w0' | 'public_id_w1' | 'name' | 'content_source_id' | 'is_leaf' | 'resource_type' | 'file_type' | 'package_id' | 'link_ext' | 'link_type' | 'icon' | 'short_descr' | 'view_limitations' | 'readme_public_id_w0' | 'readme_public_id_w1'>;
