...
})(ConsoleVerbosity = exports.ConsoleVerbosity || (exports.ConsoleVerbosity = {}));
...
class Manage {
    constructor(db, logger, console, config, dinfraLibPath, packages) {
        ...
        this.TRACE = (...args) => {
            util_1.safeTrace(this.TRACE0, ...args);
        };
        this.dinfra = require(config.dinfraPath);
        this.reset();
    ...
    async importFoundationTree() {
        ...
        try {
            ...
            rootNode = {
                ...
                publicId: dbBuilderUtils_1.createPublicIdFromTreeNodePath('ROOT')
            };
    ...
    async importPackageGroups(dir, packageGroupJsons, filterDevSetId, options = {}) {
        ...
        for (const packageGroup of packageGroupsToImport) {
            const internalId = await this.importPackageGroup(packageGroup, dir, filterDevSetId, options);
            packageGroupInternalIds.push(internalId);
        }
    ...
    async importFilterDevSet(dir, filterDevSetPubId, devicesFilename = 'devices.db', devtoolsFilename = 'devtools.db') {
        ...
        const publicVId = types_js_1.stringToVPublicId(filterDevSetPubId);
        ...
        const time = util_1.hrtimeToSec(process.hrtime(start));
    ...
    async import(dir, _filters, packageGroups, options) {
        ...
        try {
            ...
            for (const internalId of internalIds) {
                await this.publishPackageGroup(types_js_1.publicVIdToString(internalId));
            }
    ...
    async deleteContentSource(options = {}) {
        ...
        )).map(row => types_js_1.rowToContentSource(row));
        ...
        for (const contentSource of contentSources) {
            ...
            if (contentSource.type === 'devset') {
                ...
                util_2.assertNever(contentSource.type);
    ...
    */
    async getContentSources(type, criteria) {
        ...
        if (criteria && !_.isEmpty(criteria.publicVId)) {
            const { publicId, version } = types_js_1.stringToVPublicId(criteria.publicVId);
        ...
        const contentSources = (await this.db.simpleQuery('get-content-sources', sql, params)).map(row => types_js_1.rowToContentSource(row));
        if (latestOnly) {
    ...
    async importPackageGroup(packageGroupDef, dir, devGroupPubId, options = {}) {
        ...
        try {
            ...
            const parseTime = util_1.hrtimeToSec(process.hrtime(groupImportStart));
            ...
            if (options.writeToDb) {
                ...
                if (packageGroup.mainPackageUid) {
                    ...
                    if (packageGroup.mainPackage) {
                        ...
                        packageGroup.packagesToListVersionsFrom = (_b = (_a = packageAuxData[packageGroup.mainPackage.publicId]) === null || _a === void 0 ? void 0 : _a.listVersionsFromPackage) !== null && _b !== void 0 ? _b : [];
                    }
                }
                else {
                ...
                this.console.log(`Database write time: ${util_1.hrtimeToSec(process.hrtime(groupDbWriteStart))}s`);
            }
            const dbWriteTime = util_1.hrtimeToSec(process.hrtime(groupDbWriteStart));
            this.console.progressOnly(' (done)');
    ...
    async writePackageOverviewsToDb(packages) {
        ...
        await this.dbSession
            ...
            return [
                ...
                pkg.version,
                pkg.uid,
                types_js_1.decomposePlatformAttribute(pkg.installPath),
                types_js_1.decomposePlatformAttribute(pkg.installCommand),
                (_b = (_a = pkg.installSize) === null || _a === void 0 ? void 0 : _a.win) !== null && _b !== void 0 ? _b : null,
                (_d = (_c = pkg.installSize) === null || _c === void 0 ? void 0 : _c.linux) !== null && _d !== void 0 ? _d : null,
                (_f = (_e = pkg.installSize) === null || _e === void 0 ? void 0 : _e.macos) !== null && _f !== void 0 ? _f : null,
                pkg.path,
                pkg.name,
                pkg.description,
                pkg.type,
                (_g = pkg.subType) !== null && _g !== void 0 ? _g : null,
                (_h = pkg.featureType) !== null && _h !== void 0 ? _h : null,
                (_j = pkg.ccsVersion) !== null && _j !== void 0 ? _j : null,
                (_k = pkg.ccsInstallLocation) !== null && _k !== void 0 ? _k : null,
                pkg.image,
                pkg.order,
                pkg.metadataVersion,
                pkg.restrictions,
                ...
                pkg.hideByDefault,
                (_m = (_l = pkg === null || pkg === void 0 ? void 0 : pkg.moduleGroup) === null || _l === void 0 ? void 0 : _l.corePackage) === null || _m === void 0 ? void 0 : _m.packageId,
                (_p = (_o = pkg === null || pkg === void 0 ? void 0 : pkg.moduleGroup) === null || _o === void 0 ? void 0 : _o.corePackage) === null || _p === void 0 ? void 0 : _p.versionRange,
                (_s = (_r = (_q = pkg === null || pkg === void 0 ? void 0 : pkg.moduleGroup) === null || _q === void 0 ? void 0 : _q.packages) === null || _r === void 0 ? void 0 : _r.join()) !== null && _s !== void 0 ? _s : null,
    ...
    async writeFoundationTreeToDb(rootNode) {
        ...
        // batch size selected to balance memory use, speed, and transaction size
        level => {
    ...
    async writePackageGroupToDb(packageGroup, filterDevSet) {
        ...
        await this.dbSession
            ...
            filterDevSet.id,
            types_js_1.decomposeStringArray(packageGroup.packagesToListVersionsFrom, false)
        ], { ignoreDuplicates: true, ignoreWarnings: true });
        this.console.progress(WRITE_CHAR);
    }
            ...
            for (const child of packageGroupNode.children) {
                ...
                if (!toChild) {
                    ...
                    if (toChild.children.length) {
                        throw new Error('Unexpected: Content subtree head node already has children:' + nodePathToString(toChild));
                    }
                    if (!toChild.publicId) {
            ...
            for (const node of nodes) {
                if (node.resource != null && node.resource.id == null) {
                    ...
                    if (node.resource.parent) {
                        ...
                        if (!node.resource.parent.id) {
                            if ((_a = node.resource.parent.duplicateOf) === null || _a === void 0 ? void 0 : _a.id) {
                                // Resource hooked up to a duplicate of its parent resource
                                if (node.resource.parent.packageUid === node.resource.parent.duplicateOf.packageUid) {
                ...
                if (!resource) {
                    throw new Error(`Unable to find a resource for node '${nodeFullPath}' of ` +
                        `package group '${packageGroup === null || packageGroup === void 0 ? void 0 : packageGroup.publicVId}'`);
                }
                ...
                const originalRootCategory = packageCatMapping === null || packageCatMapping === void 0 ? void 0 : packageCatMapping.originalRootCategory;
                const newRootCategory = (_b = packageCatMapping === null || packageCatMapping === void 0 ? void 0 : packageCatMapping.rootCategory) === null || _b === void 0 ? void 0 : _b.join('/');
                ...
                if (!node.publicId) {
                    ...
                    node.publicId = dbBuilderUtils_1.createPublicIdFromTreeNodePath(localNodePath || '/');
                }
                ...
                if (packageCatMapping === null || packageCatMapping === void 0 ? void 0 : packageCatMapping.name) {
                ...
                node.aliasPublicIds = [
                    dbBuilderUtils_1.createPublicIdFromTreeNodePath(oldTreeFullNodePath)
                ];
    ...
    async writeResourcesToDb(resources, packages) {
        ...
        await this.dbSession.getConnection().writeDbObjsToDb('write-resources', resources, this.db.tables.resources, [
            ...
            return [
                ...
                types_js_1.decomposeStringArray(resource.viewLimitations),
                types_js_1.decomposeStringArray(resource.kernels),
                types_js_1.decomposeStringArray(resource.compilers),
                ...
                types_js_1.resourceSortToDb(resource.sort),
                resource.root0 || null,
    ...
    async writeAliasNodePublicIdsToDb(nodes) {
        await this.dbSession.getConnection().writeObjsToDb('write-aliasid-x-primaryid', nodes, this.db.tables.nodePublicIds, ['public_id_w0', 'public_id_w1', 'node_id', 'alias'], (node) => {
            ...
            const rows = _.map(node.aliasPublicIds, aliasPublicId => {
                const { publicIdWord0, publicIdWord1 } = types_js_1.nodePublicIdToDbWords(aliasPublicId);
            ...
            if (node.origGeneratedPublicId) {
                const { publicIdWord0, publicIdWord1 } = types_js_1.nodePublicIdToDbWords(node.origGeneratedPublicId);
                rows.push([publicIdWord0, publicIdWord1, node.id, true]);
            }
            // Add the node's primary public id
            const { publicIdWord0, publicIdWord1 } = types_js_1.nodePublicIdToDbWords(node.publicId);
        ...
        for (const resourceGroupInfo of _.values(resourceGroups)) {
            ...
            await this.dbSession
                ...
                return [
                    ...
                    types_js_1.decomposeStringArray(resourceGroup.viewLimitations)
                ];
            });
            ...
            const resourceGroupNodes = _.reduce(resourceGroupInfo.nodes, (acc, node) => {
                if (!_.isEmpty(node.tvDevices) || !_.isEmpty(node.tvDevtools)) {
                    acc.push(..._.map(devicesAndDevtoolsToDevs(node.tvDevices, node.tvDevtools), dev => {
                        ...
                        const compiler = types_js_1.compilerToDb(node.resource.compilers[0]);
                        const kernel = types_js_1.kernelToDb(node.resource.kernels[0]);
                        return {
                            nodeId: node.id,
    ...
    async writeNodesAndAncestorsToDb(nodes) {
        ...
        await this.dbSession.getConnection().writeDbObjsToDb('write-nodes', nodes, this.db.tables.nodes, [
            ...
            const { publicIdWord0, publicIdWord1 } = node.publicId != null
                ? types_js_1.nodePublicIdToDbWords(node.publicId)
            ...
            const { publicIdWord0: readmePublicIdWord0, publicIdWord1: readmePublicIdWord1 } = node.readmeNodePublicId != null
                ? types_js_1.nodePublicIdToDbWords(node.readmeNodePublicId)
                : { publicIdWord0: null, publicIdWord1: null };
            const isLeaf = !node.isFoundation && _.isEmpty(node.children);
            // Parent sort
            const parentSort = types_js_1.resourceSortToDb((_b = (_a = node.parent) === null || _a === void 0 ? void 0 : _a.resource) === null || _b === void 0 ? void 0 : _b.sort);
            ...
            const leafOrder = (((_d = (_c = node.parent) === null || _c === void 0 ? void 0 : _c.resource) === null || _d === void 0 ? void 0 : _d.sort) === 'filesAndFoldersAlphabetical' ||
                ((_f = (_e = node.parent) === null || _e === void 0 ? void 0 : _e.resource) === null || _f === void 0 ? void 0 : _f.sort) === 'manual')
                ? 0
                : isLeaf
                    ? 1
                    : 2;
            ...
            return [
                ...
                node.resource ? types_js_1.decomposeStringArray(node.resource.viewLimitations) : null,
                readmePublicIdWord0,
                readmePublicIdWord1
            ];
        }, { ignoreDuplicates: true, ignoreWarnings: true });
        ...
        for (const childDef of childrenDef) {
            ...
            if (addPackageGroupHeadsOnly && isFoundation) {
                ...
                childNode = {
                    ...
                    publicId: dbBuilderUtils_1.createPublicIdFromTreeNodePath(childDef.publicId)
                };
    ...
    createFilterDevSet(publicVId) {
        const { publicId, version } = types_js_1.stringToVPublicId(publicVId);
        return {
            publicVId,
            publicId,
            version,
    ...
    async parseResourceJsonFile(filepath, packageGroup, devset, packages) {
        return new Promise((resolve, reject) => {
            ...
            fileStream.on('data', (o) => {
                ...
                try {
                    ...
                    if (isOverview(value) && value.resourceType === 'packageOverview') {
                        ...
                        pkg.hideByDefault = (_a = value.hideByDefault) !== null && _a !== void 0 ? _a : false;
                        pkg.originalRootCategory = (_b = value === null || value === void 0 ? void 0 : value.modifiedValues) === null || _b === void 0 ? void 0 : _b.rootCategory;
                        pkg.rootCategory = value === null || value === void 0 ? void 0 : value.rootCategory;
                        ...
                        if (value.subType === 'featureSupport') {
                            ...
                            pkg.devtools = _(value.devtools).map(devtoolName => {
            ...
            fileStream.on('end', () => {
                ...
                this.console.fine(`File parse time: ${util_1.hrtimeToSec(process.hrtime(packageParseStart))}s`);
    ...
    addResourcePathToTree(resource, pathInfo, packageGroup, packages, duplicateNodeInfo) {
        ...
        if (resource.type === 'packageOverview') {
            ...
            if ((pkg === null || pkg === void 0 ? void 0 : pkg.moduleOf) && (pkg === null || pkg === void 0 ? void 0 : pkg.moduleOf.packageId) === (mainPackage === null || mainPackage === void 0 ? void 0 : mainPackage.publicId)) {
    ...
    async flushFiltersToDb(packageGroup) {
        ...
        await this.dbSession
            .getConnection()
            .writeObjsToDb('write-trailing-subchunks', newChunks.values(), this.db.tables.trailingSubChunks, ['chunk_id', 'subchunk'], newChunk => {
            const rows = [];
                ...
                for (const dbChunk of chunks) {
                    ...
                    switch (filter.type) {
                        ...
                        case 'tag':
                            ...
                            break;
                        default:
                            util_2.assertNever(filter.type);
            ...
            if (global.gc) {
                ...
                if (gcCalls === MAX_GC_CALLS) {
                    ...
                    this.console.log(`Forced garbage collection (%d calls, %ds) ${gcCalls} ` +
                        `${util_1.hrtimeToSec(process.hrtime(start))}`);
                }
                if (REPORT_MEM_USAGE) {
...
function packageGroupFromJson(json) {
    ...
    const publicVId = types_js_1.stringToVPublicId(uid);
    return {
        publicVId: types_js_1.publicVIdToString(publicVId),
