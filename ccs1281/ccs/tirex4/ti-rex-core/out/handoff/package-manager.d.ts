...
export declare class PackageManager {
    ...
    getEntryFromPackagesFile(args: GetPackageEntryParams): Promise<{
        entry: PackageEntryStaged | import("./util").PackageEntryValid | null;
        idx: number;
    }>;
    /**
    ...
    updatePackagesFileAndRemoveOldAssets(args: UpdatePackageParams): Promise<PackageEntry>;
    /**
    ...
    rollbackPackage(args: RollbackPackageParams): Promise<{
        oldEntry: PackageEntryStaged | import("./util").PackageEntryValid | null;
        entry: PackageEntry;
    }>;
    /**
