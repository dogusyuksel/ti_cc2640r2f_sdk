...
export declare type RefreshRequest = 'add' | 'remove' | 'nothing';
...
export declare type UploadedEntry = UploadedInstallerEntry | UploadedZipEntry;
export declare type ProcessFn = (refreshInput: RefreshRequestEntry[], refreshLog: Log) => Promise<boolean>;
export interface HandoffChecklist {
}
export declare type HandoffChecklistType = HandoffChecklist;
...
export declare type PackageEntry = PackageEntryStaged | PackageEntryValid;
/**
