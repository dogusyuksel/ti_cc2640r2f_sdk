...
async function verifyContentAndZipsGone({ contentFolder, zipsFolder, zips, content }) {
    ...
    try {
        ...
        expect_1.expect(e).to.not.exist;
    }
}
 ...
 */
async function preparePackageManager({ packageManagerFileJson, contentFolder = test_helpers_1.getUniqueFolderName(), zipsFolder = test_helpers_1.getUniqueFolderName() }) {
