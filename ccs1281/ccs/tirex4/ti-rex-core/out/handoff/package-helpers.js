...
exports.getAllPackageTirexJsonPaths = exports.getPackageTirexJsonPath = exports.zipsMirrorPackageFolderStructure = exports.moveDevPackageToSubfolder = exports.getPlaceholderPackageInfo = exports.getPackageInfo = exports.isPackageFolder = exports.getPackageFolders = void 0;
// 3rd party
...
async function getPackageFolders(folder) {
    // packageFolders
    const pattern = `${path_helpers_1.PathHelpers.normalize(folder)}**/*${vars_1.Vars.PACKAGE_TIREX_JSON}`;
    const packageJsonFolders = _.uniq((await fg(pattern, {
        dot: true,
        deep: 6
    })).map(item => path.dirname(path_helpers_1.PathHelpers.normalize(item))));
 ...
 *  @param args.packageFolder
 *
 * @returns newPackageFolder
 */
async function moveDevPackageToSubfolder({ packageFolder, extractFolder }) {
...
exports.moveDevPackageToSubfolder = moveDevPackageToSubfolder;
/**
