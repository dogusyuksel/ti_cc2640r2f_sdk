...
export declare class PackageManagerAdapter {
    ...
    addPackage({ entry, log }: AddPackageParams): Promise<util.PackageEntry>;
     ...
     */
    removePackage({ packageInfo, log, processingSuccess }: RemovePackageParams): Promise<util.PackageEntry[] | null>;
    ...
    getPackageEntry(id: string, version: string, log: Log): Promise<util.PackageEntryStaged | util.PackageEntryValid | null>;
