...
declare type CallbackFn<T> = CallbackFunctionTemplate<string, T>;
export interface InQueryValue {
    $in: (number | string | null)[] | undefined;
}
export declare type QueryValue = string | number | boolean | InQueryValue | RegExp | null;
export declare type SimpleQuery<T> = {
...
export declare type Query<T> = SimpleQuery<T> | AndQuery<T> | TextSearchQuery | IdQuery;
/**
 * Constructor
