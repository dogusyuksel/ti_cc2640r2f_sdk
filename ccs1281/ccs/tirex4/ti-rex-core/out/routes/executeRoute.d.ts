 ...
 */
export declare type ProcessDbReq<T, R> = (sqldb: Sqldb.DbSession, reqQuery: T, req?: Request) => Promise<R>;
/**
 * Optional function to provide custom response other than the default res.send
 */
export declare type RespondCustom<R> = (req: Request, res: Response, data: DatabaseResponse<R>) => void | Promise<void>;
/**
 * Execute  the route
 *
