...
function getRoutes() {
    ...
    routes.get(`/${"api/packages" /* GET_PACKAGES */}`, executeRoute_1.executeRoute(getPackages));
    routes.get(`/${"api/packageGroups" /* GET_PACKAGE_GROUPS */}`, executeRoute_1.executeRoute(getPackageGroups));
    return routes;
}
...
async function getPackages(sqldb, reqQuery, req) {
    ...
    return packageRecordsUnique.map(packageRecord => {
        ...
        return {
            ...
            licenses: packageRecord.license ? [routes_1.makeLink(packageRecord.license, 'local')] : [],
...
function decodePackageType(packageType) {
    switch (packageType) {
        case "softwareMain" /* SOFTWARE_MAIN */:
            return "MainPackage" /* MAIN_PACKAGE */;
        case "softwareSupplemental" /* SOFTWARE_SUPPLEMENTAL */:
            return "SubPackage" /* SUB_PACKAGE */;
        case "device" /* DEVICE */:
        case "devtool" /* DEVTOOL */:
            return "OtherPackage" /* OTHER */;
        default:
