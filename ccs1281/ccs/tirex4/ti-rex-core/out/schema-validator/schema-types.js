...
})(PackageSubType = exports.PackageSubType || (exports.PackageSubType = {}));
var FeatureType;
...
})(MainCategory = exports.MainCategory || (exports.MainCategory = {}));
...
})(MainCategorySubDocs = exports.MainCategorySubDocs || (exports.MainCategorySubDocs = {}));
var Restriction;
...
})(DevtoolType = exports.DevtoolType || (exports.DevtoolType = {}));
var IDE;
(function (IDE) {
    IDE["CCS"] = "ccs";
    IDE["IAR"] = "iar";
...
class RuleSettings {
    constructor() {
        this.GenericError = { priority: exports.Priority.error, enable: true, message: '%s' };
        this.DuplicateMacro = { priority: exports.Priority.error, enable: true, message: 'Macro "%s" defined in multiple places' };
        this.DuplicateElements = { priority: exports.Priority.error, enable: true, message: '"%s" Has duplicate elements. Elements need to be unique' };
        this.DependencyExists = { priority: exports.Priority.error, enable: true, message: 'Dependency not found: "%s"' };
        this.EmptyObj = { priority: exports.Priority.error, enable: true, message: '"%s" is null, empty or missing' };
        this.FieldDefined = { priority: exports.Priority.error, enable: true, message: '"%s" is required but not defined' };
        this.FieldDefinedNot = { priority: exports.Priority.error, enable: true, message: '"%s" should not be defined' };
        this.FieldFileExists = { priority: exports.Priority.error, enable: true, message: '"%s" specified file not found: "%s"' };
        this.FileExists = { priority: exports.Priority.error, enable: true, message: 'File not found: "%s"' };
        this.ItemListed = { priority: exports.Priority.error, enable: true, message: '"%s" in "%s" is not recognized. Allowable values are [%s]' };
        this.NonEmptyContent = { priority: exports.Priority.error, enable: true, message: '"%s" is empty' };
        this.NoSpecialChar = { priority: exports.Priority.error, enable: true, message: '"%s" has special character \'%s\' not allowed in "%s"' };
        this.NotSupported = { priority: exports.Priority.error, enable: true, message: 'Is not supported' };
        this.OnlyOneElement = { priority: exports.Priority.error, enable: true, message: '"%s" should only have one element in its array' };
        this.Semver = { priority: exports.Priority.error, enable: true, message: '"%s" has invalid semver: %s' };
        this.StringFormat = { priority: exports.Priority.error, enable: true, message: '"%s" is not in format of "%s"' };
        this.AssertSortValue = { priority: exports.Priority.error, enable: true, message: '"%s" must have a value of "filesAndFoldersAlphabetical", "manual" or "default"' };
        this.ValidCoreType = { priority: exports.Priority.error, enable: true, message: 'Invalid core dataType' };
        this.ValidDevice = { priority: exports.Priority.error, enable: true, message: 'Invalid device' };
        this.ValidDevTool = { priority: exports.Priority.error, enable: true, message: 'Invalid devtool' };
        this.ValidHtml = { priority: exports.Priority.error, enable: true, message: '"%s" has invalid HTML body' };
        this.ValidLocalPath = { priority: exports.Priority.error, enable: true, message: '"%s" contains invalid local path: "%s"' };
        this.ValidUrl = { priority: exports.Priority.error, enable: true, message: '"%s" has invalid link: "%s"' };
        this.WrongType = { priority: exports.Priority.error, enable: true, message: 'Datatype for "%s" should be a "%s"' };
        this.WrongObjectType = { priority: exports.Priority.error, enable: true, message: '"%s" is missing in "%s"' };
        //
        this.EmptyOptional = { priority: exports.Priority.warning, enable: true, message: '"%s" is empty, should fill in content or remove' };
        this.FileExistsNot = { priority: exports.Priority.warning, enable: true, message: 'File should not exist: "%s"' };
        this.GenericWarning = { priority: exports.Priority.warning, enable: true, message: '%s' };
        this.InSpec = { priority: exports.Priority.warning, enable: true, message: '"%s" is not a valid field' };
        this.InSpecSuggest = { priority: exports.Priority.warning, enable: true, message: '"%s" is not a valid field; do you mean: "%s"' };
        this.ItemListedOptional = { priority: exports.Priority.warning, enable: true, message: '"%s" in "%s" is not recognized. Allowable values are [%s]' };
        //
        this.OneOrMore = { priority: exports.Priority.recommended, enable: true, message: '"%s" At least one of the listed field is recommended: [%s]' };
        this.Recommended = { priority: exports.Priority.recommended, enable: true, message: '"%s" is recommended but not defined' };
        //
        this.VersionSupport = { priority: exports.Priority.info, enable: true, message: '"%s" value "%s" is not compatible with "%s"...skipping this package' };
        this.GenericInfo = { priority: exports.Priority.info, enable: true, message: '%s' };
    }
}
