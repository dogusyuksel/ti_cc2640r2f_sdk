...
class BaseLogger extends stream_1.Readable {
    constructor() {
        ...
        super(...arguments);
        this.emergency = (_message, _tags = []) => { };
        this.alert = (_message, _tags = []) => { };
        this.critical = (_message, _tags = []) => { };
        this.error = (_message, _tags = []) => { };
        this.warning = (_message, _tags = []) => { };
        this.notice = (_message, _tags = []) => { };
        this.info = (_message, _tags = []) => { };
        this.debug = (_message, _tags = []) => { };
        this.fine = (_message, _tags = []) => { };
        this.finer = (_message, _tags = []) => { };
        this.finest = (_message, _tags = []) => { };
    }
}
