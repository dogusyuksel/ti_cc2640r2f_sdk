...
class MountComponentTemporarily {
        ...
        this.queue[mountPoint]
            ...
            return new Promise((resolve, reject) => {
                try {
                    ...
                    ReactDOM.render(React.createElement(Component, Object.assign({}, props, { onClose: (...args) => {
    ...
    mountDialogTemporarily(Component, props, { mountPoint = MountPoint.DISPLAY_MOUNT, dialogProps } = {}) {
        this.mountComponentTemporarily((props) => {
            return (React.createElement(material_ui_imports_1.MuiThemeProvider, { theme: theme_1.theme(theme_config_1.getTheme()) },
                React.createElement(material_ui_imports_1.Dialog, Object.assign({}, (dialogProps ? dialogProps : {}), { open: true }),
