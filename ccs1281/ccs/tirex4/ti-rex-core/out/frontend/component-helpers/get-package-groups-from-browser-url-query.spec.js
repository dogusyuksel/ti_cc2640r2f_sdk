...
describe('[frontend] getPackageGroupsFromBrowserUrlQuery', function () {
    ...
    async function callMethod({ addedPackages, removedPackages }) {
        ...
        return get_package_groups_from_browser_url_query_1.getPackagesGroupsFromBrowserUrlQuery(addedPackages, removedPackages, allGroups, filterOptions);
    }
});
///////////////////////////////////////////////////////////////////////////////
/// Helpers
...
function validateResult(inputGroups, outputGroups) {
    ...
    outputGroups.map((outputGroup, idx) => {
        expect_1.expect(outputGroup).to.deep.equal(inputGroups[idx]);
    });
}
