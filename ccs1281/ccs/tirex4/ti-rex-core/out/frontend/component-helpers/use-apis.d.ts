...
declare type UseGetPackagesParams = UseApisBaseParams;
declare type UseGetPackageGroupsParams = UseApisBaseParams;
declare type UseGetFilterOptionsParams = UseApisBaseParams;
