...
export declare type DeviceDetectorModule = DeviceDetector & TICloudAgent.Module;
...
export declare type DetectionResult = DetectectedDevices | HostFilesMissing | UnknownError;
