...
export declare type AppPropsInitial = Omit<AppProps, 'filter' | 'filterOptions' | 'packages' | 'packageGroups' | 'selectedNode' | 'selectedNodeExtended'>;
 ...
 *
 */
export declare function getAppState(appPropsInitial: AppPropsInitial, offlineDevices?: OfflineBoardsAndDevices): Promise<AppPropsDerivedState | null>;
