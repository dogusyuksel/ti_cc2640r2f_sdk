...
function useApi(args) {
    ...
    const result = use_async_operation_1.useAsyncOperation({
        operation: async () => {
            if (!trigger) {
                return null;
            }
    ...
    const prevResult = use_previous_1.usePrevious(result, { update: trigger });
...
function useGetFilteredChildrenNodes(args) {
    ...
    return useApi({
        ...
        dependencies: [parentIds.join(','), filter_helpers_1.getBrowserUrlQueryFilterAsString(urlQuery)],
        ...args
    });
}
...
function useGetFilteredTableItems(args) {
    ...
    return useApi({
        ...
        dependencies: [parentId, filter_helpers_1.getBrowserUrlQueryFilterAsString(urlQuery), page],
        ...args
    });
}
...
function useGetNodeDataForTableItemVariant(args) {
    ...
    return useApi({
        ...
        dependencies: [
            id,
            filter_helpers_1.getBrowserUrlQueryFilterAsString(urlQuery),
            variant && util_1.getTableItemVariantAsString(variant)
        ],
        ...args
    });
}
...
function useExpandNode(args) {
    ...
    return useApi({
        ...
        dependencies: [id, filter_helpers_1.getBrowserUrlQueryFilterAsString(urlQuery)],
        ...args
    });
}
...
function useGetSearchSuggesgtions(args) {
    ...
    return useApi({
        ...
        dependencies: [text, filter_helpers_1.getBrowserUrlQueryFilterAsString(urlQuery)],
        ...args
    });
}
