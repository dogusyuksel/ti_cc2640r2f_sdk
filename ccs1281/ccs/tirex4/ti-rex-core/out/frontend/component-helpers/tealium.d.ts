...
export declare type PageViewEvent = PageViewEventWithoutPackage | PageViewEventWithPackage;
...
export declare type FileDownloadEvent = FileDownloadEventWithoutPackage | FileDownloadEventWithPackage;
...
export declare type ProjectImportEvent = ProjectImportEventWithoutPackage | ProjectImportEventWithPackage;
export declare type TirexEvent = PageViewEvent | SearchEvent | FilterEvent | PackageDownloadEvent | FileDownloadEvent | PackageInstallEvent | ProjectImportEvent;
