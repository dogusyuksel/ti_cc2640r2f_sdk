...
class NodesState {
    ...
    requestChangeNodeState(id, state) {
        this.emitter.emit("OnChangeNodeStateRequest" /* ON_CHANGE_NODE_STATE_REQUEST */, id, state);
    }
    requestExpandPath(path) {
        this.emitter.emit("OnExpandPathRequest" /* ON_EXPAND_PATH_REQUEST */, path);
    }
    // Getters
    ...
    onChangeNodeStateRequest(fn) {
        return this.emitter.on("OnChangeNodeStateRequest" /* ON_CHANGE_NODE_STATE_REQUEST */, fn);
    }
    onExpandPathRequest(fn) {
        return this.emitter.on("OnExpandPathRequest" /* ON_EXPAND_PATH_REQUEST */, fn);
    }
