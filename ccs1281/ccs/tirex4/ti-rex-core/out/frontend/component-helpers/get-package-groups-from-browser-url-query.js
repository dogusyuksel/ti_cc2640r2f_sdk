...
function getPackagesGroupsFromBrowserUrlQuery(addedPackageGroups, removedPackageGroups, allGroups, filterOptions) {
    const addedGroupsData = package_group_helpers_1.getPackageGroups(addedPackageGroups, allGroups);
    const removedGroupsData = package_group_helpers_1.getPackageGroups(removedPackageGroups, allGroups);
