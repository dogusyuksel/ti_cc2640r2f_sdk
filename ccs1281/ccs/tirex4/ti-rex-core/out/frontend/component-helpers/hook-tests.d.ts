...
declare type SetupFn<T> = () => Promise<{
    data: T;
    spy: sinon.SinonSpy;
}>;
declare type GetHookFn<T, U> = (data: U) => (() => T);
declare type VerifyResultFn<T, U> = (expectedCallCount: number, result: T, spy: sinon.SinonSpy, data: U) => Promise<void>;
