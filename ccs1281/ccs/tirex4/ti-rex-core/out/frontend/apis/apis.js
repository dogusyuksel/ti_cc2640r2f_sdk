...
class APIs {
    constructor() {
        this.apiControl = new api_control_1.APIControl();
        this.apisInternal = new apis_internal_1.APIsInternal();
    ...
    async apiWithFilterQuery(api, urlQuery, label, masterName) {
        ...
        const query = filter_helpers_1.getServerFilterQueryFromBrowserUrlQuery(urlQuery, groups, filterOptions);
