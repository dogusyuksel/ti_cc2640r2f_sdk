...
export declare type UpdatedBrowserUrlQueryItems = {
...
export declare type UpdatedFilterItems = Partial<Filter>;
export declare type FilterCommon = Common<Filter, FilterData.Options>;
