...
export declare class APIs {
    ...
    getNodes(ids: string[], masterName?: string): Promise<(Readonly<import("../../shared/routes/response-data").Nodes.LeafNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderWithResourceNode> | Readonly<import("../../shared/routes/response-data").Nodes.PackageFolderNode>)[]>;
    ...
    getFilteredChildrenNodes(parentIds: string[], urlQuery: BrowserUrlQuery.Params, masterName?: string): Promise<(Readonly<import("../../shared/routes/response-data").Nodes.LeafNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderNode> | Readonly<import("../../shared/routes/response-data").Nodes.FolderWithResourceNode> | Readonly<import("../../shared/routes/response-data").Nodes.PackageFolderNode>)[][]>;
