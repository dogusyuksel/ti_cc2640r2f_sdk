...
export declare class ApisCacheInterface {
    ...
    getNodesData(id: string): Readonly<Nodes.LeafNode> | Readonly<Nodes.FolderNode> | Readonly<Nodes.FolderWithResourceNode> | Readonly<Nodes.PackageFolderNode> | null;
    getNodesDataBulk(ids: string[]): {
        nodesData: import("lodash").Dictionary<Readonly<Nodes.LeafNode> | Readonly<Nodes.FolderNode> | Readonly<Nodes.FolderWithResourceNode> | Readonly<Nodes.PackageFolderNode>>;
        missingIds: string[];
    };
    getExtendedNodesData(id: string): Readonly<Nodes.LeafNodeExtended> | Readonly<Nodes.FolderNodeExtended> | Readonly<Nodes.FolderWithResourceNodeExtended> | Readonly<Nodes.PackageFolderNodeExtended> | null;
    getExtendedNodesDataBulk(ids: string[]): {
        extendedNodesData: import("lodash").Dictionary<Readonly<Nodes.LeafNodeExtended> | Readonly<Nodes.FolderNodeExtended> | Readonly<Nodes.FolderWithResourceNodeExtended> | Readonly<Nodes.PackageFolderNodeExtended>>;
        missingIds: string[];
    };
    ...
    setNode(nodes: Nodes.Node): Readonly<Nodes.LeafNode> | Readonly<Nodes.FolderNode> | Readonly<Nodes.FolderWithResourceNode> | Readonly<Nodes.PackageFolderNode>;
    setNodes(nodes: Nodes.Node[]): (Readonly<Nodes.LeafNode> | Readonly<Nodes.FolderNode> | Readonly<Nodes.FolderWithResourceNode> | Readonly<Nodes.PackageFolderNode>)[];
    setNodeExtended(nodes: Nodes.NodeExtended): Readonly<Nodes.LeafNodeExtended> | Readonly<Nodes.FolderNodeExtended> | Readonly<Nodes.FolderWithResourceNodeExtended> | Readonly<Nodes.PackageFolderNodeExtended>;
