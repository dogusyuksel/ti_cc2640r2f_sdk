...
const useStyles = material_ui_styles_imports_1.makeStyles((theme) => {
    const { verticalFlexContainer } = styles_1.stylesCommon(theme);
    return {
        root: {},
        paper: {
...
exports.DropdownMenu = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(context_1.ErrorContextWrapper, { errorCallbackValue: value => {
        ...
        React.createElement("div", Object.assign({ className: classnames_1.default(classes.root, className) }, rest, { ref: ref }),
            toggleInner,
            anchorEl && (React.createElement(material_ui_imports_1.Popover, Object.assign({ open: isOpen, onClose: evt => {
                    // @ts-ignore - bad typings for evt
                    evt.preventDefault();
                    onClose();
                }, anchorEl: anchorEl, style: {
                    minWidth: anchorEl.clientWidth
                }, classes: { paper: classes.paper } }, (direction === "left" /* LEFT */
                ? {
