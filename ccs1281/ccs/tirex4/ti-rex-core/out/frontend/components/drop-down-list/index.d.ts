...
export declare const DropDownList: React.ForwardRefExoticComponent<Pick<DropDownListProps, "key" | "id" | "name" | "onClose" | "style" | "className" | "classes" | "direction" | "variant" | "listProps" | "popoverProps" | "headerButtonProps" | "items"> & React.RefAttributes<any>>;
