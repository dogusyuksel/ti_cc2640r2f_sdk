...
/// Code
///////////////////////////////////////////////////////////////////////////////
const useStyles = material_ui_styles_imports_1.makeStyles((theme) => {
    return {
        root: { margin: 10 },
        errorIcon: {
...
exports.Message = React.forwardRef((props, ref) => {
    ...
    switch (messageType) {
        case MESSAGE_TYPE.ERROR: {
            return (React.createElement(material_ui_imports_1.Paper, Object.assign({ className: classnames_1.default(classes.root, classes.paper, className) }, rest, { ref: ref }),
        ...
        case MESSAGE_TYPE.INFO: {
            return (React.createElement(material_ui_imports_1.Card, { className: classnames_1.default(className, !className && classes.root) },
        ...
        default: {
            util_2.assertNever(messageType);
...
function refreshTirexPage() {
    const urlQuery = routing_helpers_1.getUrlQuery(location.search);
    const page = _.chain(location.pathname.replace(`${routing_helpers_1.getLinkPrefix()}/`, ''))
        .split('/')
        .first()
    ...
    const link = routing_helpers_1.getDefaultNodeLink({
