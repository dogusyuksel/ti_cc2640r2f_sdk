...
declare const useConfirmInstallStyles: (props?: any) => Record<"root" | "downloadSizeContainer" | "footerContainer" | "footerItem" | "messageContainer" | "modulesContainer" | "tableCellPackageName", string>;
