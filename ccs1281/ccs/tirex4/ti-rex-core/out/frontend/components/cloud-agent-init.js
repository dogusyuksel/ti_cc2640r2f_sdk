...
function CloudAgentInit(props) {
    const agentState = props.agentState || use_cloud_agent_1.getInitialAgentState();
    switch (agentState.cloudAgentInitState) {
        case "Success" /* SUCCESS */:
        case "NotInitialized" /* NOT_INITIALIZED */:
            return props.children;
        case "AgentNotInstalled" /* AGENT_NOT_INSTALLED */:
        ...
        default:
            util_2.assertNever(agentState.cloudAgentInitState);
...
const InstallCloudAgent = React.forwardRef((props, ref) => {
    ...
    // Events
    const onOpen = React.useCallback(util_1.evtHandler((evt) => {
        evt.preventDefault();
        props.mountComponentTemporarily.mountDialogTemporarily(InstallWizard, props);
    }, errorCallback), []);
    // Render
    return (React.createElement("div", Object.assign({}, rest, { ref: ref }),
...
const InstallWizard = React.forwardRef((props, ref) => {
    // Hooks
    const { result: installWizard } = use_async_operation_1.useAsyncOperation({
        operation: async () => {
    ...
    return installWizard ? (React.createElement("div", Object.assign({}, rest, { ref: ref }),
        ...
        React.createElement(material_ui_imports_1.DialogActions, null,
            React.createElement(material_ui_imports_1.Button, { id: util_1.TEST_ID.autoDetectDialogClose, onClick: onClose }, "Cancel")))) : (React.createElement("div", Object.assign({}, rest, { ref: ref })));
});
