...
const useStyles = material_ui_styles_imports_1.makeStyles((theme) => {
    const { flexItem, verticalFlexContainer } = styles_1.stylesCommon(theme);
    return {
        root: {},
        agreeButton: {
...
exports.License = React.forwardRef((props, ref) => {
    ...
    return (React.createElement("div", Object.assign({ className: classnames_1.default(classes.root, className), ref: ref }, rest),
