export function testProjectsCloud({ ccsHttpAdapterUrl, ...rest }: {
    tirexUrl: string;
    ccsHttpAdapterUrl: string;
    packages: any;
    exclude: any;
...
export namespace builder {
    ...
    export namespace ccsHttpAdapterUrl {
...
export type testProjectsCloudCallback = (error: Error, result: Object, total: number, failed: number, log: string) => any;
