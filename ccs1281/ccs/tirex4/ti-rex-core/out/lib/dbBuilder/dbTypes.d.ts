...
export declare type ResourceType = keyof typeof resourceTypes;
...
export declare type Compiler = keyof typeof compilers;
...
export declare type Kernel = keyof typeof kernels;
...
export declare type ResourceClass = keyof typeof resourceClasses;
...
export declare type ResourceSubClass = keyof typeof resourceSubClasses;
export declare function isResourceSubClass(s: string): s is ResourceSubClass;
export declare type PackageType = 'devices' | 'devtools' | 'software' | 'software_tools' | 'full';
export declare type LinkType = 'local' | 'external';
export declare type SortType = 'filesAndFoldersAlphabetical' | 'manual' | 'default';
...
export declare type SupplementsAll = Supplements & SupplementsDefinition & SupplementsLegacy;
...
export declare type DependenciesAll = Dependencies & DependenciesDefinition & DependenciesLegacy;
...
export declare type ViewLimitation = 'aws' | 'e2e' | 'guicomposer' | 'h264codec' | 'nohttps' | 'parasoft' | 'elprotronic' | 'xeltex' | 'hilosystems' | 'tlsmbed' | 'tiSensortag' | 'tiTraining' | 'tiC2000' | 'tiWiki';
export declare type PackageSubType = 'ccsComponent' | 'featureSupport';
export declare type FeatureType = 'deviceSupport';
