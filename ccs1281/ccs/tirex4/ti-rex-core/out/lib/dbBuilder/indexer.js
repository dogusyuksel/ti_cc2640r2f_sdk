...
async function index(dbPath) {
    ...
    const resourceDbFiles = fsutils_1.readDirRecursive(resourceDbFullDir, exports.regexNotIndex, 1);
    const overviewDbFiles = fsutils_1.readDirRecursive(overviewDbDir, exports.regexNotIndex, 1);
