...
declare type PureBundleDefinition = PureBundle;
...
declare type DBDefinition = ResourceDefinition & PureBundleDefinition & OverviewDefinition;
export declare type AnyDefinition = DBDefinition & PackageHeaderDefinition;
