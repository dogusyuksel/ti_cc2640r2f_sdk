...
export declare type PresentationData = PresentationNodeDB;
export declare type ResourceRecord = Resource;
...
export declare type PackageGroupRecordDB = PackageGroupDB;
...
export declare type PackageRecordDB = Package;
...
export declare type PackageRecord = MainPackageRecord | SupplementalPackageRecord | DevicePackageRecord | DevtoolPackageRecord;
...
export declare type ParentToChildrenIdMap = Map<number, number[]>;
/**
