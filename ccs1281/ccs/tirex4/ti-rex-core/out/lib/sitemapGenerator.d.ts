...
export declare function getDuplicateResourceLinks(resources: Resource[]): ResourceLinkJSON;
...
export declare function writeResourcesToSitemap(resources: Resource[], duplicateLinkFilepath: string, packageGroupPublicIdEncoded: string, packagePublicId: string, writeBuffer: fs.WriteStream, linkSummary: LinkSummary): boolean;
export declare function writeOverviewToSitemap(overviews: Overview[], packageGroupPublicIdEncoded: string, packagePublicId: string, writeBuffer: fs.WriteStream, linkSummary: LinkSummary): boolean;
