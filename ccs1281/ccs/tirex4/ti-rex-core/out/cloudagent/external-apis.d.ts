...
export declare type InstallInfo = InstallInfoAvailable | InstallInfoNotAvailable | InstallInfoInstalled | InstallInfoInstalled | InstallInfoNotSupportedOnCurrentPlatform;
