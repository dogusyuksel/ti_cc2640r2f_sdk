...
export declare type Progress = DefiniteProgress | IndefiniteProgress;
...
export declare type InputProgress = DefiniteInputProgress | IndefiniteInputProgress;
declare type InitialProgress = PartialMember<DefiniteInputProgress, 'name'> | PartialMember<IndefiniteInputProgress, 'name'>;
...
export declare type ProgressParams = Omit<ReturnType<ProgressManager['createProgressTask']>, 'registerTask'>;
export {};
