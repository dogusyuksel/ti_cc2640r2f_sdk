...
class CCSEclipseRequest {
    ...
    rediscoverProducts() {
        return this.ccsRequest(constructUrl({ pathname: "/ide/rediscoverProducts" /* REDISCOVER_PRODUCTS */, port: this.ccsPort }));
    }
    getProducts() {
        return this.ccsRequest(constructUrl({ pathname: "/ide/getProducts" /* GET_PRODUCTS */, port: this.ccsPort }));
    }
    registerListener(localPort, path) {
        return this.ccsRequest(constructUrl({
            pathname: "/ide/registerListener" /* REGISTER_LISTENER */,
            port: this.ccsPort,
            queryObj: { localPort, path }
        }));
    }
    syncSearchPath() {
        return this.ccsRequest(constructUrl({ pathname: "/ide/syncProductDiscoveryPath" /* SYNC_SEARCH_PATH */, port: this.ccsPort }));
    }
    importProject(location, targetId) {
        return this.ccsRequest(constructUrl({
            pathname: "/ide/importProject" /* IMPORT_PROJECT */,
            port: this.ccsPort,
    ...
    createProject(location, targetId) {
        return this.ccsRequest(constructUrl({
            pathname: "/ide/createProject" /* CREATE_PROJECT */,
            port: this.ccsPort,
            queryObj: targetId
                ? {
                    copyFiles: location,
    ...
    importSketch(location, targetId) {
        return this.ccsRequest(constructUrl({
            pathname: "/ide/importSketch" /* IMPORT_SKETCH */,
            port: this.ccsPort,
            queryObj: {
                sketchFile: location,
                boardId: targetId
