...
export declare type TriggerEvent = (eventName: ModuleEvents, eventData: any) => void;
export declare type OnInstalledPackagesUpdated = (packages: AgentResult<'getInstalledPackages'>) => void;
export declare type OnInstallInfoUpdated = (installLocations: AgentResult<'getPackageInstallInfo'>) => void;
export declare type OnProgressUpdated = (progress: AgentResult<'getProgress'>) => void;
