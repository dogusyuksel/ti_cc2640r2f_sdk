 ...
 *
 * The following table list the mapping between stack APIs and function names,
 * as described in the BT core spec.
 *
 * <table>
 ...
 * </table>
 *
 * The following table lists the mapping between stack APIs and function names,
 * as described in the Vendor Specific API guide included with the installer.
 *
 * <table>
 ...
 * @{
 */
#define PHY_UPDATE_COMPLETE_EVENT_1M                   1   //!< 1 Mbps
#define PHY_UPDATE_COMPLETE_EVENT_2M                   2   //!< 2 Mbps
#define PHY_UPDATE_COMPLETE_EVENT_CODED                3   //!< Coded
/** @} End PHY_UPDATE */
