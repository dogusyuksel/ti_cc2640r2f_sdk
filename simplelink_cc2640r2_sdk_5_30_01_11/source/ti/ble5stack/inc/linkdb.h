...
#define CONNHANDLE_ALL                  0xFFFD  //!< Terminates all links
#define CONNHANDLE_LOOPBACK             0xFFFE  //!< Loopback connection handle, used to loopback a message
#define CONNHANDLE_INVALID              0xFFFF  //!< Invalid connection handle, used for no connection handle
