...
//
#define LL_FEATURE_MAX_FEATURES_LSB                    0xFFFFFFFF // number of spec features 0 - 3 bytes
#define LL_FEATURE_MAX_FEATURES_MSB                    0x0000000F // number of spec features 4 - 7 bytes (bits 4 - 31 are invalid)
...
#else
//TODO: why the LL_FEATURE_MINIMUM_NUMBER_OF_USED_CHANNELS bit was set as invalid (spec define it as valid)
#define LL_FEATURE_MASK_BYTE2                          (LL_FEATURE_MINIMUM_NUMBER_OF_USED_CHANNELS)
#endif
...
#define LL_TEST_MODE_JIRA_4432                       205
...
extern void                 llRfOverrideSetValue(uint32,uint8);
