...
#define UBLE_NUM_TX_POWER_VALUE (sizeof(ubTxPowerVal) / sizeof(ubTxPowerVal_t))
...
const RF_Mode ubRfMode =
{
  ...
  .cpePatchFxn = rf_patch_cpe_ble_cte_grx,
  .mcePatchFxn = rf_patch_mce_ble_cte,
#else
  .cpePatchFxn = 0,
  .mcePatchFxn = 0,
#endif
...
uint32 ubRfRegOverride[] = {
  ...
  0xFFFF0A43, // Override advLenMask and maxAdvLen to 255
#endif
#elif defined(CC26XX)
  ...
  0x00158000,
  0x000E5164,
  ((4 << 16)|0x8BB3), // default: sampling at 4MHz clk
  ((4 << 16)|0x8BC3), // default: the starter time of sampling is 4us(BT spec)
#endif
  0xFFFFFFFF
};
...
/* Tx Power Table */
const ubTxPowerTable_t ubTxPowerTable = { ubTxPowerVal, UBLE_NUM_TX_POWER_VALUE };
