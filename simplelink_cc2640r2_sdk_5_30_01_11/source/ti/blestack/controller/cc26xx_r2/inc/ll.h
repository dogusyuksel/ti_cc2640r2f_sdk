...
#define LL_MAX_SPEC_DATA_TIME                          17040 // in us
 ...
 * @fn          LL_dynamicFree
 *
 * @brief       If an allocation fails during LL_init, this function will free
 *              all other dynamically allocated variables and send a message to the application
 *
 * input parameters
 *
 * @param       None.
 ...
 * @return      None.
 */
extern void LL_dynamicFree( void );
...
extern llStatus_t LL_SetAddressResolutionEnable_sPatch( uint8 addrResolutionEnable );
...
/*******************************************************************************
 * @fn          LL_EXT_SetScanChannels Vendor Specific API
 *
 * @brief       This API sets the scan channels mapping
 *
 * input parameters
 *
 * @param       scanChanMapVal - channel scan map definition
 ...
 *
 *				Same values of Enum GAP_scanChannels_t.
 *
 * output parameters
 *
 * @param       None.
 ...
 */
extern llStatus_t LL_EXT_SetScanChannels( uint8 scanChanMapVal );
...
#ifdef QUAL_TEST
extern void LL_DirectAdvReportCback( uint8  eventType,
                                     uint8  directAddrType,
                                     uint8 *directAddr,
                                     uint8  advAddrType,
                                     uint8 *advAddr,
