...
extern void linkDB_reportStatusChange(void);
...
extern void gapProcessBLEEvents(void);
extern void gapProcessCommandStatusEvt(void);
extern void gapProcessConnEvt(void);
extern void gapProcessHCICmdCompleteEvt(void);
extern void gapProcessOSALMsg(void);
extern void gapRegisterPeripheral(void);
extern void gapAddAddrAdj(void);
extern void gapGetDevAddress(void);
extern void gapGetDevAddressMode(void);
extern void gapGetSignCounter(void);
extern void gapGetSRK(void);
extern void gapHost2CtrlOwnAddrType(void);
extern void gapIncSignCounter(void);
extern void gapProcessNewAddr(void);
extern void gapReadBD_ADDRStatus(void);
extern void gapReadBufSizeCmdStatus(void);
extern void gapSendDeviceInitDoneEvent(void);
extern void disconnectNext(void);
extern void gapFreeAuthLink(void);
extern void gapFreeEstLink(void);
extern void gapPairingCompleteCB(void);
extern void gapPasskeyNeededCB(void);
extern void gapProcessConnectionCompleteEvt(void);
extern void gapProcessDisconnectCompleteEvt(void);
extern void gapProcessRemoteConnParamReqEvt(void);
extern void gapRegisterPeripheralConn(void);
extern void gapSendBondCompleteEvent(void);
extern void gapSendLinkUpdateEvent(void);
extern void gapSendPairingReqEvent(void);
extern void gapSendSignUpdateEvent(void);
extern void gapUpdateConnSignCounter(void);
extern void sendAuthEvent(void);
extern void sendEstLinkEvent(void);
extern void sendTerminateEvent(void);
extern void gapClrState(void);
extern void gapFindADType(void);
extern void gapIsAdvertising(void);
extern void gapIsScanning(void);
extern void gapSetState(void);
extern void gapValidADType(void);
extern void gapL2capConnParamUpdateReq(void);
extern void gapPeriProcessConnUpdateCmdStatus(void);
extern void gapPeriProcessConnUpdateCompleteEvt(void);
extern void gapPeriProcessSignalEvt(void);
extern void gapAddAdvToken(void);
extern void gapAllocAdvRecs(void);
extern void gapBuildADTokens(void);
extern void gapCalcAdvTokenDataLen(void);
extern void gapConnectedCleanUpAdvertising(void);
extern void gapDeleteAdvToken(void);
extern void gapFindAdvToken(void);
extern void gapFreeAdvertState(void);
extern void gapProcessAdvertisingTimeout(void);
extern void gapSendAdDataUpdateEvent(void);
extern void gapSendEndDiscoverableEvent(void);
extern void gapSendMakeDiscEvent(void);
extern void gapSetAdvParams(void);
extern void gapSetAdvParamsStatus(void);
extern void gapWriteAdvDataStatus(void);
extern void gapWriteAdvEnableStatus(void);
extern void isLimitedDiscoverableMode(void);
...
// use small size patches
extern void smSavePairInfo_sPatch(void);
extern void smpResponderProcessPairingReq_sPatch(void);
extern void llSetupScan_sPatch(void);
...
const uint32 ROM_Flash_JT[] =
{
  ...
  (uint32)llSetupLenCtrlPkt_sPatch,                          // ROM_JT_OFFSET[199]
  ...
  (uint32)LL_SetAddressResolutionEnable_sPatch,              // ROM_JT_OFFSET[216]
  ...
  (uint32)llAlignToNextEvent_sPatch,                         // ROM_JT_OFFSET[231]
  ...
  (uint32)llSetupScan_sPatch,								 // ROM_JT_OFFSET[294]
#else //
  (uint32)ROM_Spinlock,
#endif
...
#if ( ( HOST_CONFIG & PERIPHERAL_CFG ) || ( HOST_CONFIG & BROADCASTER_CFG) )
  ...
  (uint32)smSavePairInfo_sPatch,                             // ROM_JT_OFFSET[591]
  ...
  (uint32)smpResponderProcessPairingReq_sPatch,              // ROM_JT_OFFSET[614]
#else
